    ...
    <section className="min-h-screen flex items-center justify-center bg-slate-50 px-6">
      <div className="max-w-2xl w-full text-center">
        ...
        <div className="relative mb-8">
          <h1 className="text-[150px] md:text-[200px] font-black text-green-600/10 leading-none">
            404
          </h1>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <Link href="/" className="w-full sm:w-auto">
            <Button 
              color="success" 
              size="lg" 
              className="w-full sm:w-auto font-bold text-white px-10 shadow-lg shadow-green-200"
            >
              Back to Home
            </Button>
          </Link>
